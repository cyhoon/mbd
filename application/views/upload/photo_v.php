...
echo form_open_multipart('/upload/upload_photo',$attributes);
?>
        <fieldset>
            <legend>iMG UPLOAD</legend>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <p class="help-block">파일을 선택해 주세요</p>
                </div>
                ...
                <div class="controls">
                    <input type="text" class="input-xlarge" id="input03" name="contents" value="<?php echo set_value('contents'); ?>">
